...
class LoadingScreen(game: SpaceJourney) : BaseScreen(game, "LoadingScreen") {
    ...
    private fun actuallyLoadAssets() {
        ...
        SpaceJourney.assetManager.load("cloud_test.jpg", Texture::class.java)
        SpaceJourney.assetManager.load("parallax_medium_cloud_layer.png", Texture::class.java)
        SpaceJourney.assetManager.load("parallax_small_cloud_layer.png", Texture::class.java)
